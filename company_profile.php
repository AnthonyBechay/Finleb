        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <div class='card'>
                ...
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    <strong>Welcome!</strong> You should check in some of our website functionalities :
                    <br> You can:
                    <br> -Review and rate this profile
                    <br> -check other reviews
                    <br> -see profile pictures
                    <br>
...
?>
                ...
                <div class='tab-content admin-tab-content pt30'>
                          ...
                          <div class='col-md-3 col-sm-6'>
                              <a href='#' class='gallery-popup' title='Open Imagination'>
                                  <div class='project-item'>
                                      <div onclick='return false;' style='width:21vh; height:25vh;' class='overlay-container'>
                  ...
                  echo"
                      ...
                      $comquery = "select u2.u_fname as commenterfname,u2.u_lname as commenterlname ,u2.u_phone as phonenb ,rev_text as rev_text,u2.u_pic_path as u2_pic_path , u2.u_pic_name as u2_pic_name from user u1,user u2, company, branch, review where u1.u_id=comp_u_id AND comp_id=br_comp_id AND br_id=rev_br_id AND u2.u_id=rev_u_id AND br_id=$brcurr_id ";
                  ...
                  echo" 
                              ...
                              <li class='clearfix'>
                                  <div class='float-left'>
                                      <a href='#' onclick='return false;' data-toggle='popover' data-placement='left'   title='Contact me:' data-trigger='focus' data-content='{$row_cmt['phonenb']}'>
                                  ...
                                  <div class='act-content'>
                                      <div class='font400'>
                                          ...
                                          <a href='#' onclick='return false;' data-toggle='popover' data-placement='top'   title='Contact me:' data-trigger='focus' data-content='{$row_cmt['phonenb']}'> {$row_cmt['commenterfname']} {$row_cmt['commenterlname']}</a> Added a review
                                      </div>
